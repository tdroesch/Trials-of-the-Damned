...
//				GetComponent<AudioSource> ().PlayOneShot (GetComponent<Sound_Script> ().AudioList[1]);
//				{
//						Vector3 startPos = transform.TransformPoint (new Vector3 (2.8f, 5.6f, 5.9f));
//						Quaternion startRot = Quaternion.Euler (transform.rotation.eulerAngles + new Vector3(-90f ,0f ,0f));
